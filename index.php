					...
					<div class="scrollbar scrollbar1" id="style-2">
						<div class="activity-row">
							...
							<div class="col-xs-7 activity-desc">
								<h5><a href="#">Zipaala Godfred</a></h5>
							...
							<div class="single-bottom">
								<ul>
									<li>
										...
										<label for="brand"><span></span> Building of Sunday School Rooms.</label>
									</li>
									<li>
										<input type="checkbox"  id="brand1" value="">
										<label for="brand1"><span></span> General Meeting with All leaders.</label>
									</li>
									<li>
										<input type="checkbox"  id="brand2" value="">
										<label for="brand2"><span></span> Buying of Land for the future.</label>
									</li>
									<li>
										<input type="checkbox"  id="brand9" value="">
										<label for="brand9"><span></span> Get to together party.</label>
									</li>
									<li>
										<input type="checkbox"  id="brand8" value="">
										<label for="brand8"><span></span>Revivals.</label>
									</li>
									<li>
									...
									<li>
										...
										<label for="brand4"><span></span>Setting of I.T tools.</label>
									</li>
									<li>
										<input type="checkbox"  id="brand5" value="">
										<label for="brand5"><span></span>Organizing.</label>
									</li>
									<li>
