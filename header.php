...
<html>
<head>
<titleBlessed Pastures Admin Panel | Home :: Kongo</title>
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="index.php">BlessedPastures <span>Admin</span></a></h1>
			</div>
							...
							<li class="dropdown profile_details_drop">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(images/user.jpg) no-repeat center"> </span> 
										 <div class="user-name">
											<p>Donatus<span>Administrator</span></p>
										 </div>
