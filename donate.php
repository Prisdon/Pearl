        ...
        <div class="row">
          <div class="col-md-9">
            <header class="single-post-header clearfix">
              <h2 class="post-title">Fountain Gate Chapel, Kongo</h2>
            </header>
            <article class="post-content cause-item">
                <span class="post-meta meta-data">
                  <span><i class="fa fa-calendar"></i> 4th September,2022</span>
                  <span><i class="fa fa-archive"></i> <a href="#">BLESSED PASTURES Bolgatanga</a>, <a href="#">Kongo</a></span>
                </span>
                	...
                	<div class="col-md-5">
                        <ul class="list-group">
                          <li class="list-group-item">
                      	  ...
                      	  <li class="list-group-item"> <span class="badge">GHS3,000</span> Amount Needed </li>
                      	  <li class="list-group-item"> <span class="badge">GHS200</span> Collected yet </li>
                      	 <li class="list-group-item"> <span class="badge">2 Months</span> Days left to achieve target</li>
                        </ul>
                  		<a href="#" class="btn btn-primary btn-lg btn-block donate-paypal" data-toggle="modal" data-target="#PaymentModal">Donate Now</a>
                    </div>
                </div>
                <div class="spacer-30"></div>
                <p>The Church is seeking the aid of you to acquire musical instruments. Everything is advancing and the local drums which the church having been using, is not making service interesting.</p>
				<p>Those who plays those drums gets wounds on their palms and its becomes very difficult for them</p>
            </article>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <p class="small short">If you would prefer to call in your donation, please call +233248501155</p>
                  </div>
                </div>
              </div>
            </div>
