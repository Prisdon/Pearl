...
<!-- End Site Header --> 
  ...
  <div class="hero-slider flexslider clearfix" data-autoplay="yes" data-pagination="yes" data-arrows="yes" data-style="fade" data-pause="yes">
    <ul class="slides">
      <li class=" parallax" style="background-image:url(images/slide7.jpg);"></li>
      <li class="parallax" style="background-image:url(images/images56.jpg);"></li>
	  <li class="parallax" style="background-image:url(images/slide1.jpg);"></li>
	  <li class="parallax" style="background-image:url(images/slide8.jpg);"></li>
